        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                href="#blog"
                className="inline-block rounded-2xl border border-[#b87b6a] px-8 py-4 font-semibold text-[#b87b6a]"
              >
                Read the Blog
              </a>
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            {blogPosts.map((post) => (
              <div
                key={post.id}
                className="overflow-hidden rounded-[2rem] bg-[#fdf7f2] shadow-sm"
              >
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="text-lg leading-relaxed text-[#665a54]">
                Subscribe for blog updates and encouragement.
              </p>
            </div>
